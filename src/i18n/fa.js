const fa = {
    ...
    headerTitle: 'سامانه نظارت و مدیریت انرژی',
    ...
    countCards: {
        peopleEntered: 'افراد وارد شده',
        peopleOut: 'افراد خارج شده',
        peopleCurrentlyIn: 'افرادی که داخل هستند',
    },

    areaChart: {
        peopleIn: 'افراد وارد شده',
        peopleOut: 'افراد خارج شده',
    },

    donutChart: {
        title: 'ورود و خروج افراد'
    },


    deviceStatusCard: {
        deviceStatus: 'دستگاه ها',
        mainEntrance: 'ورودی اصلی',
        westEntrance: 'ورودی غربی',
        eastEntrance: 'ورودی شرقی',
        countToday: 'شمارش امروز',
    },
    ...
    common: {
        weekendTitle: 'اخر هفته و تعطیلات',
        week: 'آمار هفتگی',
        daily: 'آمار روزانه',
        increasePredictNextYear: 'پیشبینی آمار سال آینده',
        increasePredictNextWeak: 'پیشبینی آمار هفته آینده',
        increase: 'افزایش',
        online: 'online'
    },
