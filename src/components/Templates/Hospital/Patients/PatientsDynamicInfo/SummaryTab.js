        ...
        <>
            ...
            <div className={`${style.cardStyleA} rounded-3xl p-5`}>
                ...
                <div className={`${style.cardStyleF} rounded-xl p-5 mt-5`}>
                    ...
                    <p className={`${style.textStyleB} mt-2`}>
            ...
            <div className={`${style.cardStyleA} rounded-3xl p-5 mt-5`}>
                ...
                <div className={`${style.cardStyleF} rounded-xl p-5 mt-5`}>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>ویزیت پزشک</div>
                        <div className={`text-[12px] ms-5 ${style.textStyleB}`}>۲ ساعت قبل</div>
                    </div>
                </div>
                <div className={`${style.cardStyleF} rounded-xl p-5 mt-5`}>
                    <div className='flex items-center gap-3'>
                        <div className='w-4 h-4 glass-card-no-bg bg-[#00d0ffbb] rounded-full' />
                        <div>تجویز دارو</div>
                        <div className={`text-[12px] ms-5 ${style.textStyleB}`}>۴ ساعت قبل</div>
                    </div>
                </div>
                <div className={`${style.cardStyleF} rounded-xl p-5 mt-5`}>
                    <div className='flex items-center gap-3'>
                        <div className='w-4 h-4 glass-card-no-bg bg-[#00d0ffbb] rounded-full' />
                        <div>آزمایش خون</div>
                        <div className={`text-[12px] ms-5 ${style.textStyleB}`}>۶ ساعت قبل</div>
                    </div>
                </div>
            </div>
                ...
                <div className={`${style.cardStyleF} rounded-xl p-5 mt-5`}>
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='flex items-center gap-5'>
                            ...
                            <div>
                                <div>ضربان قلب</div>
                                <div className={`text-[12px] ${style.textStyleB}`}>bpm</div>
                            </div>
                        </div>
                ...
                <div className={`${style.cardStyleF} rounded-xl p-5 mt-5`}>
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='flex items-center gap-5'>
                            ...
                            <div>
                                <div>فشار خون</div>
                                <div className={`text-[12px] ${style.textStyleB}`}>mmHg</div>
                            </div>
                        </div>
                ...
                <div className={`${style.cardStyleF} rounded-xl p-5 mt-5`}>
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='flex items-center gap-5'>
                            ...
                            <div>
                                <div>دمای بدن</div>
                                <div className={`text-[12px] ${style.textStyleB}`}>°C</div>
                            </div>
                        </div>
                ...
                <div className={`${style.cardStyleF} rounded-xl p-5 mt-5`}>
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='flex items-center gap-5'>
                            ...
                            <div>
                                <div>اکسیژن خون</div>
                                <div className={`text-[12px] ${style.textStyleB}`}>%</div>
                            </div>
                        </div>
