...
export default function PatientCardEmergency(props) {
    ...
    return (
        <div style={{borderColor:selectedPatient.id === id ? `white` : null}} className={`w-full glass-card-b text-[12px] p-3 rounded-xl flex justify-between items-center`} onClick={()=>onPatientSelect(id)} >
