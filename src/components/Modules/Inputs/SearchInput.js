...
export default function SearchInput() {
    ...
    return (
        <div onClick={!extended ? () => setExtended(true) : null} className={`flex ${extended ? 'w-[250px]' : 'w-[54px] cursor-pointer'} transition-all duration-500 items-center bg-[var(--colBg)] px-5 py-2 gap-3 rounded-full`}>
